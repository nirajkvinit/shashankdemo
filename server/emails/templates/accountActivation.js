function accountActivation(data) {
  ...
  <html xmlns="http://www.w3.org/1999/xhtml">
    <head>
      ...
      <title>Welcome to Hashcloud Family</title>
      <style type="text/css">
        ...
        <tr>
          <td align="center" valign="top" bgcolor="#ffffff" width="100%">
            <table cellspacing="0" cellpadding="0" width="100%">
              ...
              <tr>
                <td
                  background="http://dvlalr3x7qof4.cloudfront.net/images/block-chain-2850276_1280-min.jpg"
                  bgcolor="#64594b"
                  valign="top"
                  style="background: url(http://dvlalr3x7qof4.cloudfront.net/images/block-chain-2850276_1280-min.jpg) no-repeat center; background-color: #64594b; background-position: center;"
                >
                  <!--[if gte mso 9]>
              <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="mso-width-percent:1000;height:303px;">
                <v:fill type="tile" src="http://dvlalr3x7qof4.cloudfront.net/images/block-chain-2850276_1280-min.jpg" color="#64594b" />
                          ...
                          <table cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                              <td class="mobile-padding" style="text-align:left;">
                                ...
                                Your Hashcloud Account has been activated!
                                <br /><br />
                                Login and build your first Blockchain
                                (Hyperledger, Corda, Ethereum, and more...)
