...
function emailVerification(data) {
  ...
  <html xmlns="http://www.w3.org/1999/xhtml">
    <head>
      ...
      <title>Hashcloud Email Verification Mail</title>
      <style type="text/css">
        ...
        <tr>
          <td align="center" valign="top" bgcolor="#ffffff" width="100%">
            <table cellspacing="0" cellpadding="0" width="100%">
              ...
              <tr>
                <td
                  background="http://dvlalr3x7qof4.cloudfront.net/images/bg33_03.gif"
                  bgcolor="#64594b"
                  valign="top"
                  style="background: url(http://dvlalr3x7qof4.cloudfront.net/images/bg33_03.gif) no-repeat center; background-color: #64594b; background-position: center;"
                >
                  <!--[if gte mso 9]>
              <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="mso-width-percent:1000;height:303px;">
                <v:fill type="tile" src="http://dvlalr3x7qof4.cloudfront.net/images/bg33_03.gif" color="#64594b" />
                      ...
                      >
                        <tr>
                          ...
                          >
                            ...
                            <br />
                            <h2>We hope you will have an Awesome time!</h2>
                          </td>
                        </tr>
                      </table>
                    </center>
                          ...
                          <table cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                              <td style="text-align: center;">
                                <h3>Kindly verify your email for Hashcloud</h3>
                                <br />
                              </td>
                            </tr>
                          </table>
                          ...
                          <table cellspacing="0" cellpadding="0" width="100%">
                            <tr>
                              <td class="mobile-padding" style="text-align:left;">
                                ...
                                Hello, <br /><br />
                                Thank you for registering with Hashcloud. We are
                                glad to have you on board. To move ahead and start
                                creating your networks on Hashcloud, please verify
                                your email by clicking on this link:
                                <br /><br /><a
                                  href="${data.link}"
